...
# -*- coding: utf-8 -*-
"""
Fast item-based KNN recommender on MovieLens-100k
"""
import numpy as np
import pandas as pd
...
# ---------------------------------------------------------------------
# 1. Build train/test and rating matrix
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 2. Compute item×item similarity and build sparse KNN graph
# ---------------------------------------------------------------------
# 2.1 full cosine similarity
...
# 2.2 keep only top-K neighbors per item
K_NEIGHBORS = 40
MIN_SIM = 0.05
...
# 2.3 drop weak links and build sparse matrix
